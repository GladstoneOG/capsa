...
export const POKER_SUIT_NAMES = {
    D: 'Diamonds',
    C: 'Clubs',
    H: 'Hearts',
    S: 'Spades',
};
export const POKER_COMBO_VALUES = {
    highcard: 0,
    pair: 1,
    twopair: 2,
    trips: 3,
...
export function getStartingHandName(card1, card2) {
...
export function getBotPokerAction(player, gameState, difficulty = 'medium') {
